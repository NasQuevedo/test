        ...
        success: response => {
            if (response.code === 200) {
                ...
                response.records.forEach(item => {
                    ...
                    html += "<td><button type='button' class='edit' onclick='readById("+ item.id +")' >Editar</button></td>";
                    html += "<td><button type='button' class='delete' onclick='del(" + item.id + ")'>Eliminar</button></td>";
                    html += "<tr>";
                });
